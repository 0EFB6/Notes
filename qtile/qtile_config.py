...
keys = [
    ...
    Key([mod], "a", lazy.spawn("dmenu_run -fn 'Ubuntu-16' -nb '#282a2e' -sb '#5f819d'"), desc="launch dmenu"),
    Key([mod], "w", lazy.spawn("firefox"), desc="launch firefox-esr"),
    ...
    Key([mod], "z", lazy.spawn("brave"), desc="launch brave-browser"),
